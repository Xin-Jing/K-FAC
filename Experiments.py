...
if __name__ == '__main__':
    ...
    def objective2(params,minibatch_size,inputs_minibatch, targets_minibatch, numlayers, layer_sizes, layer_types ):
        a_inc = []
        ...
        return objective(outputs, params, targets_minibatch, layer_types, L2_reg=1)
    ...
    def one_forwardpass_and_two_backward_pass(params,inputs_minibatch, targets_minibatch, numlayers, layer_sizes, layer_types):
        ...
        # flattened_gradient, un_flatten = flatten(D_W_b)
        # flattened_gradient = flattened_gradient/minibatch_size
        # D_W_b = un_flatten(flattened_gradient)
    ...
    flattened_grad, un_flatten, flattened_params = flatten_func(one_forwardpass_and_two_backward_pass, init_params)
